...
- Firewalls -> you shold always monitor your firewall logs
- Public Facing Servers -> all traffic to and from as well as any application logs
- Wireless -> you should monitor failed connection atempts on your wireless infrastructure
...
Some methods for retieving logs from networked devices:
...
- Netstat -> it is a built-in utility in Windows/Mac/Linux that shows active connections to your machine. Excelletn for troubleshooting
